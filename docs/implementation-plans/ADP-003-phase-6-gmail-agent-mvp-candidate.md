...
| 2 | `WO-037: Gmail Message Eligibility, Retrieval, and Classification` | Implemented - Pending PR Review | Complete PR review and CI gate | PR merged with eligibility retrieval, minimized metadata/content handling, schema validation, uncertainty behavior, and no downstream drafting |
