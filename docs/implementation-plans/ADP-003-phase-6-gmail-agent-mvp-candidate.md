...
| 5 | `WO-040: Ask-Instead-of-Guess and Governed Fact Use` | Implemented - Pending PR Review | Complete PR review and CI gate | PR merged with missing/stale fact question behavior, answer validation, fact revisions, and prohibited-source exclusion |
