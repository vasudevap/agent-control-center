...
| 3 | `WO-031: Approval Decision and Manual-Handling Contracts` | Implemented Locally - Pending PR/CI/Merge | Complete governed PR, CI, and merge evidence before closeout | PR merged with approval queue, evidence, decision, edit-then-approve, manual-handling, authorization, and audit tests |
| 4 | `WO-028: Run Lifecycle and Job Intake Contracts` | Implemented Locally - Pending PR/CI/Merge | Complete governed PR, CI, and merge evidence before closeout | PR merged with run lifecycle, queue handoff, idempotency, cancellation, timeout, and audit tests |
| 5 | `WO-030: Knowledge Question and Answer Lifecycle` | Implemented Locally - Pending PR/CI/Merge | Complete governed PR, CI, and merge evidence before closeout | PR merged with question, answer, validation, fact-update, webhook enqueue, and audit tests |
