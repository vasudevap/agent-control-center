...
provider-native secrets boundaries.

## ADR Triggers

Create a proposed ADR before implementation if any ADP-005 Work Order would:

- change hosting provider, database provider, or deployment topology;
...
This ADR assessment is proposed for Repository Maintainer review. It does not
authorize deployment or provider actions until accepted with ES-008 and
ADP-005.
