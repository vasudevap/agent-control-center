...
| 4 | `WO-067: Heartbeat and Execution Ingestion` | Completed - Local Validation Passed | Implement authenticated heartbeat and execution ingestion with replay, bounds, redaction, and rate limits | Independent agents can submit accepted telemetry without Atlas runtime control |
