...
| ---: | --- | --- | --- | --- |
| 1 | `WO-045: Controlled-Account Release Verification` | Completed - Merged | Complete | Controlled-account evidence executed and cleaned up, or deferral explicitly accepted |
