...
non-secret production environment labels, local frontend validation, historical
Netlify 502 and 404 evidence, current production deploy evidence, browser
runtime-health evidence, and the Netlify rollback target.
