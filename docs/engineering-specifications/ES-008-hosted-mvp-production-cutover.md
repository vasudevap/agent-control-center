...
**Related Work Orders:** `docs/work-orders/053-production-environment-and-secrets-provisioning.md` through `docs/work-orders/060-release-tag-and-production-closeout.md`
...
| Hosted environment URLs | Not provisioned under this ES yet |
| Production secrets | Not created, stored, or handled in source |
...
### 5.4 Google OAuth production client and redirects
...
### 5.5 Migration, backup, restore, and cutover rehearsal
...
### 5.6 Hosted smoke testing and monitoring
...
### 5.7 Rollback rehearsal and release withdrawal
...
### 5.8 Go/no-go, release tag, and closeout
