...
ADR-005 is proposed for draft-support knowledge and ask-instead-of-guess
behavior and is awaiting Architecture and Security Review.
...
- Review ADR-005 for acceptance before R8 implementation planning
