...
- [`ADR-005 - Draft-Support Knowledge and Ask-Instead-of-Guess`](./ADR-005-draft-support-knowledge-and-ask-instead-of-guess.md) - Proposed; extends the generic external product client contract with governed draft-support facts, facts-used evidence, non-authorizing questions and answers, and Gmail agent asking and learning behavior.
