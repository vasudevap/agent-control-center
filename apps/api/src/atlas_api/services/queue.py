...
def claim(
    ...
    *,
    ...
    _recover_expired_leases(session, current)
...
def succeed(session: Session, *, job_id: str, lease_token: str, now: datetime) -> None:
...
def cancel(session: Session, *, job_id: str, now: datetime) -> None:
