...
export function ApprovalsWorkspace({ approvals, presentationState = "ready" }: { approvals: ApprovalRecord[]; presentationState?: Presentation }) {
  ...
  return <div className="flex min-w-0 flex-col gap-8">
    <PageHeader title="Approvals" description="Review human approval requests and governance context for the Atlas AI workforce." icon={ShieldCheck} />
    <Notice />
